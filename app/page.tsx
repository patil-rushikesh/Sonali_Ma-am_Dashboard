...
const navigationItems = [
  { id: "testimonials", label: "Testimonials", icon: User, description: "Manage client testimonials" },
  { id: "experience", label: "Experience", icon: Briefcase, description: "Work experience timeline" },
  { id: "talks", label: "Talks Delivered", icon: Mic, description: "Speaking engagements" },
  { id: "publications", label: "Publications", icon: BookOpen, description: "Research publications" },
  { id: "patents", label: "Patents", icon: FileText, description: "Patent applications" },
  { id: "copyrights", label: "Copyrights", icon: Copyright, description: "Copyright registrations" },
  { id: "startups", label: "Startups", icon: Rocket, description: "Startup ventures" },
  { id: "grants", label: "Research Grants", icon: DollarSign, description: "Funding and grants" },
  { id: "gallery", label: "Gallery", icon: ImageIcon, description: "Image gallery" },
]
